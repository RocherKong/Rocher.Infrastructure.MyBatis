namespace IBatisNet.DataMapper.TypeHandlers.Nullables
{
    ...
    public sealed class NullableUInt64TypeHandler : BaseTypeHandler
    {
        ...
        {
            return new ulong?(Convert.ToUInt64(outputValue));
        }
        ...
        public override object GetValueByIndex(ResultProperty mapping, IDataReader dataReader)
        {
            ...
            return new ulong?(Convert.ToUInt64(dataReader.GetValue(mapping.ColumnIndex)));
        }
        ...
        public override object GetValueByName(ResultProperty mapping, IDataReader dataReader)
        {
            ...
            return new ulong?(Convert.ToUInt64(dataReader.GetValue(ordinal)));
        }

        public override void SetParameter(IDataParameter dataParameter, object parameterValue, string dbType)
        {
            ulong? nullable = (ulong?) parameterValue;
